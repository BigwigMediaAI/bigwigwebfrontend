...
const PopupForm: React.FC<PopupFormProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className={`fixed top-0 left-0 w-full h-full bg-[var(--color1)] overflow-y-scroll p-3 rounded-b-2xl shadow-xl ${
      ...
      >
        ...
        <div className="w-full flex justify-center">
          <button
            onClick={handleClose}
            className="text-white bg-[var(--secondary-color)] px-4 py-1 rounded-full text-lg font-bold shadow-sm hover:opacity-80 transition"
          >
            ✕
          </button>
        </div>
        ...
        {/* HEADER */}
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-2 text-[var(--primary-color)]">
          Let&#39;s Grow Together 🚀
        </h2>
        ...
        {step === "form" ? (
          <form
            ...
            className="space-y-5 w-full md:w-3/4 mx-auto text-white"
          >
            {/* NAME + EMAIL */}
            ...
            <div className="flex gap-3">
              <select
                className="p-2 border rounded-lg bg-[var(--color1)] text-white w-32"
              ...
              <input
                ...
                className="w-full p-2 border rounded-lg bg-[var(--color1)] text-white"
